<?php
 ...
 $pw_file = "/usr/share/nginx/html/code/php/passwords.json";
 $audit_file = "/usr/share/nginx/html/logs/audit.log";
 $audit_on = 1;
  ...
  function audit( $what, $message ) {
    ...
    $callers = explode("\n", $callers);
    if (strpos( $callers[1], "/usr/share/nginx/html/code/php/AC.php" ) !== FALSE)
