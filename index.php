...
?>
  ...
  <body>
    ...
    <div id="about-box-info" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
      <div class="modal-body">
          <p>The functionality displayed here was developed as part of the Pedriatric Imaging, Neurocognition and Genetics (PING) study at UC San Diego.</p>
          <p style="float: right;">Hauke Bartsch, Dr. rer. nat.</p>
      </div>
      <div class="modal-footer">
    ...
    <div id="contact-box-info" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
      ...
      <div class="modal-body">
          <p>Questions should be directed to Hauke Bartsch (hbartsch at ucsd.edu) and the Multi-Modal Imaging Laboratories (MMIL) at UC San Diego.</p>
          <p>UCSD Address:<br/>
	...
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
	    ...
	    <a class="brand" href="#">Data Portal v0.1</a>
...
<?php endif; ?>
	...
	<div class="span4">
	  ...
	  <p><a class="btn" href="/applications/Ontology/hierarchy.php?entry=display" title="Structure browser">Hierarchy &raquo;</a>&nbsp;
...
<?php endif; ?>
 ...
 <!--     <div class="featurette">
	...
	<p>&copy; 2013 Multi-modal imaging laboratory, UC San Diego, Radiology &middot; <!-- <a href="#">Privacy</a> &middot;--> <a href="#" data-toggle="modal" data-target="#legal">Terms</a></p>
      </footer>
    </div><!-- /.container -->
    ...
    <script type="text/javascript">
      ...
      function switchProject(newProject) {
        ...
        if (typeof projects[newProject].numCols != "undefined") {
          ...
          var per = 100 * (projects[newProject].numCols * projects[newProject].numRows - projects[newProject].numNAs) / (projects[newProject].numCols * projects[newProject].numRows);
          ...
          str += " <tr><td>female:</td><td class='table-value'>" + projects[newProject].female + "</td></tr>";
				    str += "</table>";
          str += "<br><br><small><sup>*</sup>includes user defined measures and " + whatisthis + "</small>";
        }
