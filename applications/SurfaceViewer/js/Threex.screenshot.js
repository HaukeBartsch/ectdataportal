	...
	var _aspectResize	= function(srcUrl, dstW, dstH, callback){
		...
		var onLoad	= function(){
			...
			ctx.drawImage(image, offsetX, offsetY, scaled.width, scaled.height);
		        window.tweenTo( new THREE.Vector3(0,0,0), new THREE.Vector3(0,0,-300), new THREE.Vector3(0,1,0), false );
			ctx.drawImage(image, offsetX+200, offsetY+200, scaled.width/4, scaled.height/4);
