...
<html lang="en">
    <head>
      ...
      <link href="surfaceviewer.css" rel="stylesheet" type="text/css"/>
...
function switchMeasure(selectIndex) {
  ...
  if (selectIndex > 0) { // read in a different dataset (zscores/tscores)
    ...
    jQuery.getJSON( "/code/StatisticsGAM2/user_data/vertexdata_main_effect_and_interaction_"
    ...
    jQuery.getJSON( "/code/StatisticsGAM2/user_data/vertexdata_main_effect_and_interaction_"+project_name+"_"+user_name+"_"+cookie+"_"+f+"-rh.json", function(a) {
	if (typeof a.entries == "undefined") {
	  rightValues = a;
	} else {
    ...
    jQuery.getJSON( "/code/StatisticsGAM2/user_data/vertexdata_"+project_name+"_"+user_name+"_"+cookie+"_geometry-lh.json", function(a) {
	      if ( typeof a.entries == "undefined" ) {
	      	geomLValues = a;
	      } else {
    ...
    jQuery.getJSON( "/code/StatisticsGAM2/user_data/vertexdata_"+project_name+"_"+user_name+"_"+cookie+"_geometry-rh.json", function(a) {
	      if ( typeof a.entries == "undefined" ) {
	      	geomRValues = a;
	      } else {
    ...
    jQuery.getJSON( "/code/StatisticsGAM2/user_data/vertexdata_"+project_name+"_"+user_name+"_"+cookie+"_"+f+"-lh.json", function(a) {
    ...
    jQuery.getJSON( "/code/StatisticsGAM2/user_data/vertexdata_"+project_name+"_"+user_name+"_"+cookie+"_"+f+"-rh.json", function(a) {
      if (typeof a.entries == "undefined") {
	rightValues = a;
      } else {
	rightValues = a.entries[0];
