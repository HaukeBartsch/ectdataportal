...
//	$authmethod = 'htpasswd';
	...
	$auth = Array (
		'dataportal' => Array ('pass' => 'ba57d2f7a74939c1af614b8adda27d92968c1206', 'name' => 'dataportal', 'email' => 'hbartsch@ucsd.edu')
	);

	// passwords are sha1 hashes, uncomment next line to create the password hash:
//	exit (sha1 ('dataportal'));
...
//	$author = $auth ['testuser2']['name'] . '<' . $auth ['testuser2']['email'] . '>'; // 'firstname lastname <email-address>'
	$author = 'Hauke Bartsch <hbartsch@ucsd.edu>';
